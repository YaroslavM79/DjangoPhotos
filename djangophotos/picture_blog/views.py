...
class EditPicture(LoginRequiredMixin, UpdateView):
    model = PictureBlog
    login_url = '/login/'
...
class DeletePicture(LoginRequiredMixin, DeleteView):
    model = PictureBlog
    login_url = '/login/'
...
class ViewPicture(DetailView):
    model = PictureBlog
    template_name = 'picture_blog/show_user_picture.html'
    context_object_name = 'picture'



class MyPicturesView(LoginRequiredMixin, ListView):
    model = PictureBlog
    login_url = '/login/'
